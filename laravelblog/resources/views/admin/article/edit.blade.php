        		...
        		<div class="mws-form-inline">
        			<div class="mws-form-row">
        				...
        				<div class="mws-form-item small">
        					<input type="text" class="mws-textinput" name="title" value="{{$info->title}}">
        				</div>
        			</div>
                    <div class="mws-form-row">
        			...
        			<div class="mws-form-row">
        				<label>文章主图</label>
        				<div class="mws-form-item small">
                            <img src="{{$info->img}}" width="40" alt="">
        					<input type="file" class="mws-textinput" name="img" value="">
        				</div>
        			</div>
        			...
        			<div class="mws-form-row">
        				<label>文章内容</label>
        				<div class="mws-form-item small">
                            <!-- {!!$info->content!!} 不对内容做出实体化操作 {{$info->content}} 对内容做出实体化操作 -->
        					<textarea id="editor" rows="" cols="" style="width:800px;height:200px;" name="content">{!!$info->content!!}</textarea>
        				</div>
        			</div>
